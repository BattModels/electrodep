...
#MOOSE supports reading field data from ExodusII, XDA/XDR, and mesh checkpoint files (.e, .xda, .xdr, .cp)
  file = liqcrys_Kp_p_1.0E+00_c_1.0E-08_other.e
...
[GlobalParams]
  enable_jit = true
  penalty = 1.00E+00
  constfactor = 1.00E-08
  penaltyconstfactor = 5.09E-02
[]
...
# family= LAGRANGE
  ...
  order = FIRST
  scaling = 1e+8
#  initial_from_file_var = nlc
  [../]
  [./gradeta]
  family = LAGRANGE_VEC
  order = FIRST
  scaling = 1e+5
#  initial_from_file_var = gradeta
  [../]
  [./lambda]
  scaling = 1e+8
...
[AuxVariables]
  ...
  order = FIRST
  family = MONOMIAL
#  initial_from_file_var = edf
  [../]
  [./epen]
  order = FIRST
  family = MONOMIAL
#  initial_from_file_var = epen
  [../]
  [./surfpen]
  order = FIRST
  family = MONOMIAL
#  initial_from_file_var = surfpen
  [../]
  [./lcovp]
  order = FIRST
  family = MONOMIAL
#  initial_from_file_var = lcovp
  [../]
[]
...
[Kernels]
  active = 'gradeta gradeta_setval nlc_diff nlc_surf nlc_mag lagrange w_dot Diffusion1 Diffusion2 poteqn coupled_pot BVnlc BV coupled_etadot AC_bulk AC_int AC_bulk_lc_penalty Noiseeta e_dot'
  [./gradeta]
...
#  dtmin = 1e-8
  ...
  nl_rel_tol = 1e-6
  nl_abs_tol = 1e-12
  petsc_options_iname = '-pc_type -ksp_gmres_restart -sub_ksp_type -sub_pc_type -pc_asm_overlap -sub_pc_factor_shift_type'
  petsc_options_value = 'asm      101                  preonly      ilu          1 nonzero'
  petsc_options =  "-snes_view -snes_converged_reason -ksp_converged_reason -ksp_monitor_true_residual"
