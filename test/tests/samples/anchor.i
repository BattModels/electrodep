...
#1;95;0c1;95;0c w is the chemical potential, eta is the phase-field, pot is the electric potential, op is the overpotential
...
[Kernels]
  active = 'gradeta gradeta_setval nlc_surf nlc_mag lagrange w_dot Diffusion1 Diffusion2 poteqn coupled_pot BVnlc BV coupled_etadot AC_bulk AC_int AC_bulk_lc_penalty e_dot'
  [./gradeta]
...
[Preconditioning]
  ...
  petsc_options_value = 'asm      121                  preonly       lu           1'
  [../]
[]
...
#  dtmin = 1e-8
  ...
  petsc_options_value = 'asm      31                  preonly      ilu         1  NONZERO  0.0001'
