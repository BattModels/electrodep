...
registerMooseObject("electrodepApp", KineticsLiqCrysVarNeg);

template <>
InputParameters
validParams<KineticsLiqCrysVarNeg>()
{
  InputParameters params = validParams<Kernel>();
  params.addClassDescription("Add in KineticsLiqCrysVarNeg");
...
KineticsLiqCrysVarNeg::KineticsLiqCrysVarNeg(const InputParameters & parameters)
...
Real
KineticsLiqCrysVarNeg::computeQpResidual()
{
