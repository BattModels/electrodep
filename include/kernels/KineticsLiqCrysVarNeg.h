#ifndef KINETICSLIQCRYSVARNEG_H
#define KINETICSLIQCRYSVARNEG_H

#include "Kernel.h"
#include "DerivativeMaterialInterface.h"
#include "JvarMapInterface.h"

class KineticsLiqCrysVarNeg;

template <>
InputParameters validParams<KineticsLiqCrysVarNeg>();

class KineticsLiqCrysVarNeg: public DerivativeMaterialInterface<JvarMapKernelInterface<Kernel>>
{
public:
  KineticsLiqCrysVarNeg(const InputParameters & parameters);
